...
[#img-quality]
[![Quality gate](https://sonarcloud.io/api/project_badges/quality_gate?project=oracle-devrel_terraform-oci-ocloud-landing-zone)](https://sonarcloud.io/dashboard?id=oracle-devrel_terraform-oci-ocloud-landing-zone)
