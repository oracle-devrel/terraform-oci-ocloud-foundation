...
* Display Name  - freetext arguments inside resource blocks refering to resources in the console and in log files
* Name          - unique arguments to identify resources, describe dependencies and define policies
* DNS Label     - unique arguments prologuing URL, the use of letters and special characters needs to comply with {rfc-1035}[RFC 1035] 
...
| README   | Group for inspecting and auditing the use of a tenancy
|===
