...
* DNS Label     - unique resource argument, prologuing the URL, needs to comply with ifndef:env-github[]{rfc-1035}[RFC 1035]endif:[], up to 15 alpha numeric characters 
